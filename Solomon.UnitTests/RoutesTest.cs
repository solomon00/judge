...
namespace Solomon.UnitTests
{
    ...
    public class RoutesTest
    {
        ...
        public void TestIncomingRoutes()
        {
            ...
            TestRouteMatch("~/Home", "Home", "Index", null, "GET");
            TestRouteMatch("~/Home/Index", "Home", "Index", null, "GET");
            TestRouteMatch("~/Home/About", "Home", "About", null, "GET");

            TestRouteMatch("~/Tournament/List", "Tournament", "List", null, "GET");

            TestRouteMatch("~/Tournament/1", "Problem", "Problem", new { TournamentID = "1" }, "GET");
            TestRouteMatch("~/Tournament/1/Problem/4", "Problem", "Problem", new { TournamentID = "1", ProblemID = "4" }, "GET");
